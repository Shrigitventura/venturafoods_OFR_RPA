...
specific_date <- as.Date("2025-05-12")

### Daily Processing ###


#Shri local folder locations
ofr <- read_excel("C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/OFR/Daily Updates/2025/05.12.2025/ofr.xlsx")
csv_data <- read_csv("C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/OFR/Daily Updates/2025/05.12.2025/csv.csv")
...
saveRDS(compared_data, "OFR_data_base_05.12.2025.rds")
...
file.rename(from = "OFR_data_base_05.12.2025.rds", to = "rds/OFR_data_base_05.12.2025.rds")
