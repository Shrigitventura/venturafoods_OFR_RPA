...
specific_date <- as.Date("2024-11-06")

### Daily Processing ###
#################################################################### Read Files ####################################################################
ofr <- read_excel("C:/Users/sschiflett/OneDrive - Ventura Foods/Documents/OFR/Review Files for Teams/OFR Master List for Review 11.06.24.xlsx")
csv_data <- read_csv("C:/Potential Shortages/CSV files/OE630CR_779458_20241106.csv")
