...
specific_date <- as.Date("2025-01-09")

### Daily Processing ###
#################################################################### Read Files ####################################################################
ofr <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/OFR/Daily Updates/2025/01.09.2025/ofr.xlsx")
csv_data <- read_csv("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/OFR/Daily Updates/2025/01.09.2025/csv.csv")
...
saveRDS(compared_data, "OFR_data_base_01.09.2025.rds")
...
file.rename(from = "OFR_data_base_01.09.2025.rds", to = "rds/OFR_data_base_01.09.2025.rds")
