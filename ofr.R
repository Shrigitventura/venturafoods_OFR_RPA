...
specific_date <- as.Date("2024-07-01")
...
saveRDS(compared_data, "OFR_data_base_07.01.2024.rds")
...
file.rename(from = "OFR_data_base_07.01.2024.rds", to = "rds/OFR_data_base_07.01.2024.rds")
