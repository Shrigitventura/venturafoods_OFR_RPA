...
specific_date <- as.Date("2024-11-14")

### Daily Processing ###
#################################################################### Read Files ####################################################################
ofr <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/OFR/Daily Updates/2024/11.14.2024/ofr.xlsx")
csv_data <- read_csv("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/OFR/Daily Updates/2024/11.14.2024/csv.csv")
...
saveRDS(compared_data, "OFR_data_base_11.14.2024.rds")
...
file.rename(from = "OFR_data_base_11.14.2024.rds", to = "rds/OFR_data_base_11.14.2024.rds")
