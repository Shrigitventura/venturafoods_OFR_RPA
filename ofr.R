...
specific_date <- as.Date("2024-08-14")

### Daily Processing ###
#################################################################### Read Files ####################################################################
ofr <- read_excel("C:/Users/sschiflett/OneDrive - Ventura Foods/Documents/OFR/Review Files for Teams/OFR Master List for Review 08.14.24.xlsx")
csv_data <- read_csv("C:/Potential Shortages/CSV files/OE630CR_473826_20240814.csv")
####################################################################################################################################################
...
saveRDS(compared_data, "OFR_data_base_08.14.2024.rds")
...
file.rename(from = "OFR_data_base_08.14.2024.rds", to = "rds/OFR_data_base_08.14.2024.rds")
