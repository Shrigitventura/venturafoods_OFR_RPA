...
specific_date <- as.Date("2024-05-22")

### Daily Processing ###
#################################################################### Read Files ####################################################################
ofr <- read_excel("C:/Users/sschiflett/OneDrive - Ventura Foods/Documents/OFR/Review Files for Teams/OFR Master List for Review 05.22.24.xlsx")
csv_data <- read_csv("C:/Potential Shortages/CSV files/OE630CR_144182_20240522.CSV")
####################################################################################################################################################
...
saveRDS(compared_data, "OFR_data_base_05.22.2024.rds")
...
file.rename(from = "OFR_data_base_05.22.2024.rds", to = "rds/OFR_data_base_05.22.2024.rds")
